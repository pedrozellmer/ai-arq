...
(function () {
  ...
  // Efeito medido: no BLOG (página estática, sem supabase-js) o arquivo saía
  // no `return` e a captura de origem NUNCA rodava. Visitante novo que chegava
  // do Google num post registrava `view_blog_post` SEM `src` — e, se depois
  // navegasse pro site e se cadastrasse, o first-touch já estava perdido: o
  // referrer vira ai.arq.br e ele é carimbado como "direto".
  // Prova no banco: dos 9 `view_blog_post`, os 4 COM src eram todos do mesmo
  // navegador (que já tinha o dado salvo de julho); os 5 sem src eram cids
  // novos. Todos os outros eventos do site: 100% com src.
  // 🔑 Mesma família do conserto de 28/08 (a telemetria subiu pra antes do
  // guarda e a origem ficou pra trás) — meio conserto é o mais caro.
