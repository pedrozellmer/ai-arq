...
SHEET_PATTERNS = {
    ...
    SheetType.PONTOS:       [
        ...
        # 🩸 22/09/2026 (job 844603fb): prancha codificada "<proj>-ELE-E-<nº>-R01"
        # não casava nada acima e a planta de PONTOS caiu no genérico de
        # arquitetura. A SIGLA vale igual à palavra por extenso — mas só como
