...
(function () {
  ...
  var WA_LOGO = '<svg width="36" height="36" viewBox="0 0 32 32" fill="#fff" aria-hidden="true">' +
  ...
  function mount() {
    ...
    wrap.style.cssText = 'position:fixed;right:20px;bottom:20px;z-index:9998;';

    var a = document.createElement('a');
    a.href = href; a.target = '_blank'; a.rel = 'noopener noreferrer';
    a.setAttribute('aria-label', 'Falar com o AI.arq no WhatsApp');
    a.title = 'Fale com a gente no WhatsApp';
    a.style.cssText = 'display:inline-flex;align-items:center;justify-content:center;width:60px;height:60px;border-radius:9999px;background:#25D366;box-shadow:0 6px 22px rgba(37,211,102,.5);transition:transform .15s ease,box-shadow .15s ease;';
    a.innerHTML = WA_LOGO;
    a.onmouseover = function () { a.style.transform = 'translateY(-2px) scale(1.06)'; a.style.boxShadow = '0 12px 30px rgba(37,211,102,.6)'; };
    a.onmouseout = function () { a.style.transform = ''; a.style.boxShadow = '0 6px 22px rgba(37,211,102,.5)'; };
